...
import before from '@/images/photos/before.jpg'
import after from '@/images/photos/after.jpg'
  ...
  return (
    <div className="mt-16 sm:mt-20">
      <div className="flex overflow-hidden gap-5 justify-center py-4 -my-4 sm:gap-8">
        {[image1, after, image3, image4, image5].map((image, imageIndex) => (
          <div
            key={image.src}
            className={clsx(
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base font-bold text-zinc-600 dark:text-zinc-400">
            MOKU O KEAWE, PU UANAHULU TO KAULANAMAUNA
          </p>
